...
import {
  ...
  compressedTicks,
  formatBase100Value,
  formatComparisonTick,
  formatComparisonTooltipLabel,
  shouldNormalizeComparisonByPoints,
  type ComparisonPoint,
  type PortfolioComparisonSerie
} from "./portfolio-comparison-data";

export type { PortfolioComparisonSerie } from "./portfolio-comparison-data";
